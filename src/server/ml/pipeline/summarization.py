...
class SummarizationPipeline:
    ...
    def __init__(self, logger=None, handler = None, provider = None):
      ...
      self.logger.info("Init ML.Pipeline.Summarization for provider:{}".format(str(provider)))
    ...
    def __run_superinsight(self, input, min_length):
      ...
      self.logger.info("Init ML.Pipeline.Summarization.__run_superinsight:model_inputs", model_inputs)
      ...
      self.logger.info("Init ML.Pipeline.Summarization.__run_superinsight:model_output")
