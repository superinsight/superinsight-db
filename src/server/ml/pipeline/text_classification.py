...
class TextClassificationPipeline:
    ...
    def __init__(self, logger=None, handler=None, provider=None):
        ...
        self.logger.info(
            "TextClassificationPipeline init for provider:{}".format(str(self.provider))
        )

    def __del__(self):
        self.logger.info(
            "TextClassificationPipeline exiting for provider:{}".format(
                str(self.provider)
            )
        )
    ...
    def __run_superinsight(self, inputs=None, labels=[]):
        ...
        self.logger.info(
            "Init ML.Pipeline.TextClassification.__run_superinsight:model_inputs",
            model_inputs,
        )
        url = "{}/zero-shot-classification".format(
        ...
        self.logger.info(
            "Init ML.Pipeline.TextClassification.__run_superinsight:model_output"
        )
