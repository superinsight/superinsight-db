...
class Translation:
    ...
    def predict(
        ...
        for input in inputs:
            ...
            if source_language != target_language:
                translation = pipeline.run(
                    input=input, src_lang=source_language, tgt_lang=target_language
                )
        ...
        (
            ...
            table_schema,
            table_name,
        ) = SqlGenerator().scriptCreateTranslationPredictOutputTable(
        ...
        for predicted in predictions:
            ...
            sql_insert = SqlGenerator().scriptInsertTranslationPredictOutputTable(
