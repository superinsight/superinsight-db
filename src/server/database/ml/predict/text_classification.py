...
class TextClassification:
    ...
    def predict(self,inputs,  labels, database=None, database_user = None):
      ...
      sql, table_schema, table_name = SqlGenerator().scriptCreateTextClassificationPredictOutputTable(predict_id=predict_id, labels=labels, database_user = database_user)
      ...
      for predicted in predictions:
        ...
        sql_insert = SqlGenerator().scriptInsertTextPredictOutputTable(predict_id=predict_id, text=text, params=params)
